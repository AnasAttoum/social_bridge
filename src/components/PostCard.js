    ...
    return (
        <div className={`p-5 pb-1 rounded-lg ${styles.card}`}>
            ...
            <div className={`flex justify-evenly mt-5 ${styles.icons}`}>
                ...
                <div className='flex justify-center items-center gap-5 p-2 rounded-md' onClick={() => { setButtons(prev => ({ ...prev, like: !prev.like })) }}>
                    {buttons.like ?
                    ...
                    <div style={buttons.like ? { color: 'var(--primary)', transition: 'all .3s' } : { transition: 'all .3s' }}>Like</div>
                </div>

                <div className='flex justify-center items-center gap-5 p-2 rounded-md' onClick={() => { setButtons(prev => ({ ...prev, save: !prev.save })) }}>
                    {buttons.save ?
